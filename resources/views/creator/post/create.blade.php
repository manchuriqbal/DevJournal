...
@section('content')
    <div class="bg-white p-6 rounded-lg shadow-md mb-8 max-w-3xl mx-auto">
        ...
        <form action="{{ route('creator.posts.store') }}" method="POST" class="space-y-6" enctype="multipart/form-data">
            @csrf
            <!-- Title -->
            <div>
            ...
            <!-- Author -->
            <input type="hidden" name="postable_type" value="App\Models\Creator">
            <input type="hidden" name="postable_id" value="{{ auth()->guard('creator')->id() }}">
