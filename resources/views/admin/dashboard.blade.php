                    ...
                    <div class="ml-5 w-0 flex-1">
                        ...
                        <dd class="flex items-baseline">
                            ...
                            <div class="ml-2 flex items-baseline text-sm font-semibold text-green-600">
                                ...
                                {{round($postPercentage) }}% from last month
                            </div>
                        </dd>
                    </div>
                </div>
                    ...
                    <div class="ml-5 w-0 flex-1">
                        ...
                        <dd class="flex items-baseline">
                            ...
                            <div class="ml-2 flex items-baseline text-sm font-semibold text-green-600">
                                <i class="fas fa-arrow-up text-xs"></i>
                                <span class="sr-only">Increased by</span>
                                {{ round($viewPercentage) }}% from last month
                            </div>
                        </dd>
                    </div>
                </div>
                    ...
                    <div class="ml-5 w-0 flex-1">
                        ...
                        <dd class="flex items-baseline">
                            ...
                            <div class="ml-2 flex items-baseline text-sm font-semibold text-green-600">
                                <i class="fas fa-arrow-up text-xs"></i>
                                <span class="sr-only">Increased by</span>
                                {{ round($commentPercentage) }}% from last month
                            </div>
                        </dd>
                    </div>
                </div>
                    ...
                    <div class="ml-5 w-0 flex-1">
                        ...
                        <dd class="flex items-baseline">
                            ...
                            <div class="ml-2 flex items-baseline text-sm font-semibold text-red-600">
                                ...
                                {{ round($likePercentage) }}% from last month
                            </div>
                        </dd>
                    </div>
                </div>
                            ...
                            <div class="flex items-center">
                                <div class="min-w-0 flex-1">
                                    ...
                                    <h4 class="text-md font-medium text-gray-900 truncate">
                                        {{ Str::limit(ucfirst($post->title), 100, '...')}}
                                    </h4>
                                    <div class="mt-2 flex">
                        ...
                        <div class="space-y-2">
                            @foreach ($topCategorys as $category)
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-sm text-gray-500">{{ $category->posts_count  }} articles</span>
                                </div>
